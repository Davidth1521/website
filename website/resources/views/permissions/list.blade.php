...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">بخش لیست دسترسی</h5>
                    ...
                    <tr>
                        <td class="idCheckbox">
                            <div class="custom-control custom-checkbox custom-control-inline">
                                <input type="checkbox" id="customCheckBoxInline_{{$key}}" name="checked[]" class="custom-control-input" value="{{$permission->id}}" onclick="any(this);">
                                <label class="custom-control-label" for="customCheckBoxInline_{{$key}}"></label>
                            </div>
                        </td>
                        <td>{{$key+1}}</td>
                        <td></a>{{$permission->name}}</td>
