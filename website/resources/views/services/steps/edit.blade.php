...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">بخش  ویرایش روند کاری</h5>
            <form action="{{route('steps.update',['id'=>$item->id])}}" method="post">
                {{csrf_field()}}
                {{method_field('PATCH')}}
                <div class="row">
                ...
                <div class="row d-block ml-1">
                    <div class="form-group">
                        <a href="/service/steps" type="submit" class="btn btn-danger float-right mr-3" >بازگشت</a>
