...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">بخش افزودن شریک</h5>
            <form action="{{route('partners.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="form-group col-sm-5 mr-3">
                        ...
                        <input type="text" class="form-control" id="customFile" name="title" placeholder="عنوان">
                    </div>
                    <div class="form-group col-sm-5 mr-3">
                        <label for="customFile">لینک</label>
                        <input type="text" class="form-control" id="customFile" name="link" placeholder="لینک">
                    </div>
                </div>
                <div class="row">
