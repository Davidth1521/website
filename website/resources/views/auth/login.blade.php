    ...
    <div class="row align-items-center h-100-vh">
        ...
        <div class="col-lg-4 offset-lg-1 p-t-b-25">
            <div class="d-flex align-items-center m-b-20">
                ...
                <h3 class="m-0">ورود به پنل مدیریت</h3>
            </div>
            <p>اطلاعات خود را وارد کنید.</p>
            <form method="POST" action="{{ route('login') }}">
                @csrf
                <div class="form-group mb-4">
                    <input type="text" name="email" class="form-control form-control-lg @error('email') is-invalid @enderror" id="exampleInputEmail1" autofocus placeholder="ایمیل یا نام کاربری" value="{{ old('email') }}">
                </div>
                <div class="form-group mb-4">
                    <input type="password" class="form-control form-control-lg @error('password') is-invalid @enderror" id="exampleInputPassword1" placeholder="رمز عبور" name="password">
                </div>
