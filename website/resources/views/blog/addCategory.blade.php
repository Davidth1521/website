...
@section('content')
    ...
    <div class="page-header">
        <div>
            <h3>افزودن دسته مقاله</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/admin/blog">مقاله</a></li>
                    <li class="breadcrumb-item">افزودن دسته</li>
                </ol>
            </nav>
        </div>
        {{--
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">بخش افزودن دسته مقاله</h5>
                ...
                <table class="table table-bordered mt-4">
                    ...
                    @foreach($allCategories as $category)
                        <tr>
                            ...
                            <td>
                                <form action="/admin/blog/removeCategory/{{$category->id}}" method="post" id="remove">
                                    {{csrf_field()}}
