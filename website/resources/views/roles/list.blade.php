...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">بخش لیست نقش</h5>
                                ...
                                {{--<div class="form-group col-sm-6">--}}
                                    ...
                                    <div class="custom-control custom-checkbox custom-checkbox-primary">
                                        <input type="checkbox" class="custom-control-input" value="{{$role->id}}"
                                               onclick="any(this);" id="customCheck_{{$role->id}}" name="roles[]">
                                        <label class="custom-control-label" for="customCheck_{{$role->id}}"></label>
                                    {{--</div>--}}
                                </div>
                                {{--<input type="checkbox" class="custom-control-input" value="{{$role->id}}" id="customCheck_{{$role->id}}" name="roles[]" onclick="any(this);">
                                    <label class="custom-control-label" for="customCheck_{{$role->id}}"></label>--}}
                            </td>
                            <td>{{$key+1}}</td>
                            <td>{{$role['name']}}</td>
